...
export default class EmailDistribution extends Vue {
    ...
    async onSubmit() {
      ...
      if(this.planOrReportTab === 'PLAN') {
        ...
        this.unitPlanModifiedData.emailDistributionMaterialPlanData = this.emailDistributionMaterialPlanData;
        if (this.isPlanDirty()) {
          try {
        ...
        this.unitReportModifiedData.emailDistributionMaterialData = this.emailDistributionMaterialData;
    ...
    previousBtn() {
      ...
      this.$router.replace('/plan-and-report-edit/dawah-material-distribution/audio-distribution')
      tab.click()
    }
    mounted() {
