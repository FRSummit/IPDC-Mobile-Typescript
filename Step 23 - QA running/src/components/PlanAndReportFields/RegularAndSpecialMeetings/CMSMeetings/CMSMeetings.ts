...
export default class CMSMeetings extends Vue {
    ...
    async onSubmit() {
      ...
      if(this.planOrReportTab === 'PLAN') {
        ...
        this.unitPlanModifiedData.cmsMeetingProgramPlanData = this.cmsMeetingProgramPlanData;
        ...
        this.unitReportModifiedData.cmsMeetingProgramData = this.cmsMeetingProgramData;
    ...
    previousBtn() {
      ...
      this.$router.replace('/plan-and-report-edit/regular-and-special-meetings/worker-meetings')
      tab.click()
    }
    mounted() {
