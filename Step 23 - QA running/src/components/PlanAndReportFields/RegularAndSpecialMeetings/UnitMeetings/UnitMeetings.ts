...
export default class UnitMeetings extends Vue {
    ...
    async onSubmit() {
      ...
      if(this.planOrReportTab === 'PLAN') {
        ...
        this.unitPlanModifiedData.unitMeetingProgramPlanData = this.unitMeetingProgramPlanData;
        ...
        this.unitReportModifiedData.unitMeetingProgramData = this.unitMeetingProgramData;
