...
export default class StateOuting extends Vue {
    ...
    async onSubmit() {
      ...
      if(this.planOrReportTab === 'PLAN') {
        ...
        this.unitPlanModifiedData.stateOutingMeetingProgramPlanData = this.stateOutingMeetingProgramPlanData;
        ...
        this.unitReportModifiedData.stateOutingMeetingProgramData = this.stateOutingMeetingProgramData;
    ...
    nextBtn() {
      let tab = document.querySelectorAll('.my_tab')[7] as HTMLElement
      this.$router.replace('/plan-and-report-edit/regular-and-special-meetings/iftar-gathering')
      tab.click()
    }
    previousBtn() {
