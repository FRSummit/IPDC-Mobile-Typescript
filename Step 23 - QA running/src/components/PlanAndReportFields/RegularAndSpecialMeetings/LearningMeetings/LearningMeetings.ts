...
export default class LearningMeetings extends Vue {
    ...
    async onSubmit() {
      ...
      if(this.planOrReportTab === 'PLAN') {
        ...
        this.unitPlanModifiedData.learningMeetingProgramPlanData = this.learningMeetingProgramPlanData;
        ...
        this.unitReportModifiedData.learningMeetingProgramData = this.learningMeetingProgramData;
