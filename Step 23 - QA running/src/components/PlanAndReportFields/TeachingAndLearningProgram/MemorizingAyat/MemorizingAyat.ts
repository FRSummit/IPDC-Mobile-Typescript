...
export default class MemorizingAyat extends Vue {
    ...
    async onSubmit() {
      ...
      if(this.planOrReportTab === 'PLAN') {
        ...
        this.unitPlanModifiedData.memorizingAyatTeachingLearningProgramPlanData = this.memorizingAyatTeachingLearningProgramPlanData;
        ...
        this.unitReportModifiedData.memorizingAyatTeachingLearningProgramData = this.memorizingAyatTeachingLearningProgramData;
