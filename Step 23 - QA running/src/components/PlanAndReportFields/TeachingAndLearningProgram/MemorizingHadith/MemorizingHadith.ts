...
export default class MemorizingHadith extends Vue {
    ...
    async onSubmit() {
      ...
      if(this.planOrReportTab === 'PLAN') {
        ...
        this.unitPlanModifiedData.memorizingHadithTeachingLearningProgramPlanData = this.memorizingHadithTeachingLearningProgramPlanData;
        ...
        this.unitReportModifiedData.memorizingHadithTeachingLearningProgramData = this.memorizingHadithTeachingLearningProgramData;
