...
export default class CleanUpAustralia extends Vue {
    ...
    async onSubmit() {
      ...
      if(this.planOrReportTab === 'PLAN') {
        ...
        this.unitPlanModifiedData.cleanUpAustraliaSocialWelfarePlanData = this.cleanUpAustraliaSocialWelfarePlanData;
        if (this.isPlanDirty()) {
          try {
        ...
        this.unitReportModifiedData.cleanUpAustraliaSocialWelfareData = this.cleanUpAustraliaSocialWelfareData;
    ...
    nextBtn() {
      let tab = document.querySelectorAll('.my_tab')[8] as HTMLElement
      this.$router.replace('/plan-and-report-edit/social-welfare/Other')
      tab.click()
    }
    previousBtn() {
      let tab = document.querySelectorAll('.my_tab')[6] as HTMLElement
      this.$router.replace('/plan-and-report-edit/social-welfare/food-distribution')
      tab.click()
    }
    mounted() {
