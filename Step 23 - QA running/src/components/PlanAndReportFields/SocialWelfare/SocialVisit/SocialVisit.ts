...
export default class SocialVisit extends Vue {
    ...
    async created() {
      ...
      if(tabActivationForPlanOrReport === 'PLAN') {
        ...
        this.initialJson = JSON.stringify(initialData);
        this.socialVisitSocialWelfareData = this.unitReport.socialVisitSocialWelfareData;
        this.target = localStorage.getItem('socialWelfare_socialVisitSocialWelfareData') ? JSON.parse(localStorage.getItem('socialWelfare_socialVisitSocialWelfareData')!).target : this.unitReport.socialVisitSocialWelfareData.target;
        this.dateAndAction = localStorage.getItem('socialWelfare_socialVisitSocialWelfareData') ? JSON.parse(localStorage.getItem('socialWelfare_socialVisitSocialWelfareData')!).dateAndAction : this.unitReport.socialVisitSocialWelfareData.dateAndAction;
        this.actual = localStorage.getItem('socialWelfare_socialVisitSocialWelfareData') ? JSON.parse(localStorage.getItem('socialWelfare_socialVisitSocialWelfareData')!).actual : this.unitReport.socialVisitSocialWelfareData.actual;
        this.comment = localStorage.getItem('socialWelfare_socialVisitSocialWelfareData') ? JSON.parse(localStorage.getItem('socialWelfare_socialVisitSocialWelfareData')!).comment : this.unitReport.socialVisitSocialWelfareData.comment;
      }
    ...
    async onSubmit() {
      ...
      if(this.planOrReportTab === 'PLAN') {
        ...
        this.unitPlanModifiedData.socialVisitSocialWelfarePlanData = this.socialVisitSocialWelfarePlanData;
        if (this.isPlanDirty()) {
          try {
        ...
        this.unitReportModifiedData.socialVisitSocialWelfareData = this.socialVisitSocialWelfareData;
    ...
    nextBtn() {
      let tab = document.querySelectorAll('.my_tab')[3] as HTMLElement
      this.$router.replace('/plan-and-report-edit/social-welfare/Transport')
      tab.click()
    }
    previousBtn() {
