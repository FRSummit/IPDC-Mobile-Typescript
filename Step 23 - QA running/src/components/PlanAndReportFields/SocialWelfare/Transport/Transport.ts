...
export default class Transport extends Vue {
    ...
    async onSubmit() {
      ...
      if(this.planOrReportTab === 'PLAN') {
        ...
        this.unitPlanModifiedData.transportSocialWelfarePlanData = this.transportSocialWelfarePlanData;
        if (this.isPlanDirty()) {
          try {
        ...
        this.unitReportModifiedData.transportSocialWelfareData = this.transportSocialWelfareReportData;
    ...
    nextBtn() {
      let tab = document.querySelectorAll('.my_tab')[4] as HTMLElement
      this.$router.replace('/plan-and-report-edit/social-welfare/Shifting')
      tab.click()
    }
    previousBtn() {
