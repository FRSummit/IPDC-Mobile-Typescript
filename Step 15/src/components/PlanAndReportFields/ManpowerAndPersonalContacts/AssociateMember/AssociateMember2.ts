...
export default class AssociateMember extends Vue {
    ...
    async created() {
      ...
      if(tabActivationForPlanOrReport === 'PLAN') {
        ...
        if(this.associateMemberPlanData.upgradeTarget === null) {
    ...
    planInputReadable() {
      ...
      if(this.associateMemberPlanData.upgradeTarget !== null) target.readOnly = true
      if(this.associateMemberPlanData.nameAndContactNumber !== null) nameAndContactNumber.readOnly = true
      if(this.associateMemberPlanData.action !== null) action.readOnly = true
    }
    reportInputReadable() {
      // this.readable = true
      let target: any = document.querySelector('#target')
      ...
      if(this.associatememberReportData.upgradeTarget !== null) target.readOnly = true
      if(this.associatememberReportData.nameAndContactNumber !== null) nameAndContactNumber.readOnly = true
      if(this.associatememberReportData.action !== null) action.readOnly = true
      if(this.associatememberReportData.lastPeriod != null) lastPeriod.readOnly = true
      if(this.associatememberReportData.thisPeriod !== null) thisPeriod.readOnly = true
      if(this.associatememberReportData.increased !== null) increased.readOnly = true
      if(this.associatememberReportData.decreased !== null) decreased.readOnly = true
      if(this.associatememberReportData.comment !== null) comment.readOnly = true
      if(this.associatememberReportData.personalContact !== null) memberContact.readOnly = true
    }
