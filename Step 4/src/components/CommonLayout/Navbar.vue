          ...
          <v-menu bottom right>
            ...
            <v-list>
              ...
              <v-list-item class="mr-0" style="min-height: 30px;">
                <v-list-item-title @click="logout" v-if="this.$store.state.userIsAuthorized" style="border-bottom: 0; position: relative; text-align: right;">
                    Logout
