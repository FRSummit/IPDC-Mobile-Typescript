...
export default class ReportLanding extends Vue {
    ...
    localStorageData() {
        ...
        // this.unitPlanModifiedData.bookSaleMaterialPlanData = 
        // this.unitPlanModifiedData.bookDistributionMaterialPlanData = 
        // this.unitPlanModifiedData.vhsSaleMaterialPlanData = 
        // this.unitPlanModifiedData.vhsDistributionMaterialPlanData = 
        // this.unitPlanModifiedData.emailDistributionMaterialPlanData = 
        // this.unitPlanModifiedData.ipdcLeafletDistributionMaterialPlanData = 
        // this.unitPlanModifiedData.otherSaleMaterialPlanData = 
        // this.unitPlanModifiedData.otherDistributionMaterialPlanData = 


        // this.unitPlanModifiedData.baitulMalFinancePlanData = 
        // this.unitPlanModifiedData.aDayMasjidProjectFinancePlanData = 
        // this.unitPlanModifiedData.masjidTableBankFinancePlanData = 
