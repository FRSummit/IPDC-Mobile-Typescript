...
export default class OtherMeetings extends Vue {
    ...
    async onSubmit() {
      if(this.planOrReportTab === 'PLAN') {
        ...
        this.unitPlanModifiedData.otherMeetingProgramPlanData = this.otherMeetingProgramPlanData;
        ...
        this.unitReportModifiedData.otherMeetingProgramData = this.otherMeetingProgramData;
    ...
    changeTab() {
      this.$router.push('/plan-and-report-edit/teaching-and-learning-program/group-study-discussion')
    }
